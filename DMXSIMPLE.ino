...
void setup() {
  ...
  ** highest channel you DmxSimple.write() to. */
  ...
  DmxSimple.usePin(4);   // digital output for DMX serial data
  DmxSimple.write(3, 255);     // set fixture #1 master brightness to max
  

  Serial.println("DMX Manual Control");
  Serial.println();
  Serial.println("Syntax:");
  Serial.println(" 123c : use DMX channel 123 (range: 1-512)");//here we only have 3 channel on the fixture #1 master on a 3 channel mode
